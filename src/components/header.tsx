...
const Header = memo(() => {
  ...
  return (
    <>
      <div className="flex justify-between items-center px-8 py-6 w-full bg-white">
      ...
      {search && (
        <div className="fixed bg-white z-10 md:min-w-main max-w-main h-full w-full  px-8 py-6  md:min-w-main">
